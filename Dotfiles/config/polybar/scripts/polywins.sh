...
active_text_color="#F7C196"
active_bg=
active_underline="#F7C196"

inactive_text_color="#F7C196"
inactive_bg=
inactive_underline=

separator="||"
show="window_title" # options: window_title, window_class, window_classname
forbidden_classes="Polybar Conky Gmrun lattedock"
empty_desktop_message="Mach was auf! Hier ist ja nichts los!"
